...
I am driven by a relentless obsession with Artificial Intelligence — not merely as software, but as the key to decoding the fundamental laws of existence. My work bridges the gap between computational intelligence and the physics of the cosmos, exploring how algorithms can mirror the mechanics of the universe itself.

For me, code is secondary; understanding the nature of reality is primary. I focus on the intersection of Deep Learning and Astrophysics, aiming to build systems capable of solving the complex phenomena occurring across the cosmos — from the behavior of subatomic particles to the evolution of galaxies. My goal is not just to engineer intelligent systems, but to use them to unlock the deepest mysteries of the universe.
...
<div align="center">
  <table width="75%">
    <tr>
      <td align="center">
        <br>
        <i>"The cosmos is within us. We are made of star stuff. We are a way for the universe to know itself."</i>
        <br>
        <br>
        <b>— Carl Sagan</b>
        <br>
...
![Reinforcement Learning](https://img.shields.io/badge/Reinforcement_Learning-009966?style=for-the-badge)
![Machine Learning](https://img.shields.io/badge/Machine_Learning-1E90FF?style=for-the-badge)
![Computer Vision](https://img.shields.io/badge/Computer_Vision-FF007F?style=for-the-badge)
...
**Novaz-Edd/Novaz-Edd** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
